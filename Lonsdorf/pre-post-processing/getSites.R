...
# Save sites
sites           = dfOBServFieldData[c("study_id","site_id","latitude","longitude")]
sites$startDate = startDate
sites$endDate   = endDate
sites$refYear   = refYear
# sites_file  = "C:/Users/angel/git/OBServ_models/data/sites.csv"
sites_file  = "C:/Users/angel.gimenez/git/OBServ_models/data/sites.csv"
