...
if __name__ == '__main__':
    ...
    with open('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/myCViterator.pkl', 'rb') as file:
    ...
    # df_results_train.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/hyperparameters/feature_selection_train_NuSVR_1-30.csv', index=False)
    # df_results_test.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/hyperparameters/feature_selection_test_NuSVR_1-30.csv', index=False)
    df_results_train = pd.read_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/hyperparameters/feature_selection_train_NuSVR_1-30.csv')
    df_results_test = pd.read_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/hyperparameters/feature_selection_test_NuSVR_1-30.csv')
    # Plot
    ...
    pyplot.savefig('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/plots/feature_selection_NuSVR_1-30.tiff', format='tiff')
    # Select n_features:
    ...
    data_reduced_train.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/data_reduced_7.csv', index=False)
    data_reduced_test.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/test/data_reduced_7.csv', index=False)
    ...
    df_results.to_csv(
        path_or_buf='C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/hyperparameters/feature_selection_BayesianRidge_3-40.csv',
        index=False)
    # Plot
    ...
    data_reduced_train.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/data_reduced_16.csv', index=False)
    data_reduced_test.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/test/data_reduced_16.csv', index=False)
    ...
    data_reduced_train.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/data_reduced_RFECV.csv',
                              index=False)
    data_reduced_test.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/test/data_reduced_RFECV.csv',
                             index=False)
