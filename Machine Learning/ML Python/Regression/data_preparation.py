...
def add_mechanistic_values(df_data, model_name='Lonsdorf.Delphi_lcCont1_open1_forEd0_crEd0_div0_ins0max_dist0_suitmult'):
    data_dir = "C:/Users/Angel/git/OBServ/Observ_models/data/"
...
if __name__ == '__main__':
    ...
    # df_data.to_csv(path_or_buf='C:/Users/Angel/git/OBServ/Observ_models/data/GA calibration/Validation/data_raw.csv', index=False)
    ...
    df_train.drop(columns=['study_id', 'site_id', 'author_id']).to_csv(path_or_buf='C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/data_prepared.csv', index=False)
    df_test.drop(columns=['study_id', 'site_id', 'author_id']).to_csv(path_or_buf='C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/test/data_prepared.csv', index=False)
    ...
    train_withIDs.to_csv(path_or_buf='C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/data_prepared_withIDs.csv', index=False)
    test_withIDs.to_csv(path_or_buf='C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/test/data_prepared_withIDs.csv', index=False)
    ...
    with open('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/myCViterator.pkl', 'wb') as f:
    ...
    profile.to_file("C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/profiler.html")
    ...
    data_sel.to_csv("C:/Users/Angel/git/OBServ/Observ_models/data/ML/kLAB/features.csv", index=False)
