...
if __name__ == '__main__':
    ...
    fig.tight_layout()
    plt.show()
    plt.savefig('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/plots/feature_importance.eps', format='eps', bbox_inches='tight')
    ...
    # data_reduced_train.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/train/data_reduced_13.csv', index=False)
    # data_reduced_test.to_csv('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/test/data_reduced_13.csv', index=False)
