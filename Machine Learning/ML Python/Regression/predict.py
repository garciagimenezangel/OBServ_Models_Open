...
if __name__ == '__main__':
    n_features = 47  # use n_features = 0 to use every predictor
    if n_features:
        train_prepared = get_train_data_reduced(n_features)
        test_prepared = get_test_data_reduced(n_features)
    else:
    ...
    # plt.savefig('C:/Users/Angel/git/OBServ/Observ_models/data/ML/Regression/plots/predictions.eps', format='eps')
