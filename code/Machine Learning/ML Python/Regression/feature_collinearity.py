...
# fig.tight_layout()
# plt.show()
plt.savefig('C:/Users/Angel/git/Observ_models/data/ML/Regression/plots/dendrogram.eps', format='eps', bbox_inches='tight')
...
for t in thresholds:
    ...
    df_results = pd.read_csv('C:/Users/Angel/git/Observ_models/data/ML/Regression/tables/feature_collinearity.csv')
    fig = plt.figure()
    ...
    # df_results.to_csv('C:/Users/Angel/git/Observ_models/data/ML/Regression/tables/feature_collinearity.csv', index=False)
    plt.savefig('C:/Users/Angel/git/Observ_models/data/ML/Regression/plots/feature_collinearity.tiff', format='tiff', bbox_inches='tight')
...
vif.to_csv('C:/Users/Angel/git/Observ_models/data/ML/Regression/tables/vif.csv', index=False)
...
df_clusters.to_csv('C:/Users/Angel/git/Observ_models/data/ML/Regression/tables/feature_clusters.csv', index=False)
